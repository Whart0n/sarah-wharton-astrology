<img src="/images/about.jpg" alt="Sarah Wharton Astrology" className="rounded-xl shadow-lg mb-8 w-full max-w-xs mx-auto block" />

<h2 className="text-2xl md:text-3xl font-manrope font-bold text-rose-quartz-400 mb-6">My Journey to Astrology</h2>
