        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <p className="text-xl md:text-2xl text-cool-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0 font-sora">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-manrope font-bold text-rose-quartz-400 mb-6">What to Expect in a Reading</h2>
            <p className="text-lg text-cool-gray-400 mb-6">
            ...
            <p className="text-lg text-cool-gray-400 mb-8">
            ...
            <div className="mt-8">
              <Link href="/services">
                <button className="rounded-full px-8 py-3 bg-powder-blue-500 hover:bg-powder-blue-600 text-white font-sora text-lg tracking-wide transition-all transform hover:-translate-y-1 shadow-md">
                  Explore My Services
                </button>
              </Link>
            </div>
